...
Go to to http://github.com/neo4j-contrib/neo4j-apoc-procedures/releases/{apoc-release}[the latest release] for *Neo4j version {branch}*
 and download the binary jar to place into your `$NEO4J_HOME/plugins` folder.
...
| http://github.com/neo4j-contrib/neo4j-apoc-procedures/releases/3.5.0.2[3.5.0.2^] | 3.5.0 (3.5.x)
| http://github.com/neo4j-contrib/neo4j-apoc-procedures/releases/3.4.0.4[3.4.0.4^] | 3.4.10 (3.4.x)
