...
public class Fingerprinting {
    ...
    @UserFunction
    @Description("calculate a checksum (md5) over the full graph. Be aware that this function does use in-memory datastructures depending on the size of your graph.")
