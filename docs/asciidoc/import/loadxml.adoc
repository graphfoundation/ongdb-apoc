...
NOTE: in previous releases we've had `apoc.load.xmlSimple`. This is now deprecated and hsa been superseded by `apoc.load.xml(url, [xPath], [config], true)`.Simple XML Format
...
We have the file here, https://raw.githubusercontent.com/graphfoundation/ongdb-apoc/{branch}/src/test/resources/xml/books.xml[on GitHub].

== Simple XML Format

In a simpler XML representation, each type of children gets its own entry within the parent map.
...
----
call apoc.load.xml("https://raw.githubusercontent.com/graphfoundation/ongdb-apoc/{branch}/src/test/resources/xml/books.xml", '', {}, true)
----
...
[source,cypher,subs=attributes]
----
CALL apoc.load.xml("https://raw.githubusercontent.com/graphfoundation/ongdb-apoc/{branch}/src/test/resources/xml/books.xml", '/catalog/book[genre=\"Computer\"]')
YIELD value as book
...
[source,cypher,subs=attributes]
----
call apoc.load.xml('https://raw.githubusercontent.com/graphfoundation/ongdb-apoc/{branch}/src/test/resources/xml/books.xml', '/catalog/book[@id="bk102"]/author')
...
[source,cypher,subs=attributes]
----
CALL apoc.load.xml("https://raw.githubusercontent.com/graphfoundation/ongdb-apoc/{branch}/src/test/resources/xml/books.xml")
----
...
You have to filter over the sub-elements  in the `_children` array in this case.
...
[source,cypher,subs=attributes]
----
call apoc.load.xml("https://raw.githubusercontent.com/graphfoundation/ongdb-apoc/{branch}/src/test/resources/xml/books.xml") yield value as catalog
UNWIND catalog._children as book
...
----
CALL
apoc.xml.import("https://raw.githubusercontent.com/graphfoundation/ongdb-apoc/{branch}/src/test/resources/xml/books.xml",{createNextWordRelationships:
true})
YIELD node
RETURN node;
