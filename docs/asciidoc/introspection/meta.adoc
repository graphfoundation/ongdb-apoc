...
| apoc.meta.cypher.types(node or relationship or map) | returns a map of property-keys to their names
|===
...
| apoc.meta.types(node or relationship or map) | returns a map of property-keys to their names
|===
