...
The 'LAT' will be replaced with the latitude and 'LNG' will be replaced with the longitude to reverse geocode when the procedure is called.
...
latitude and longitude to Cypher Point types, and then use the distance() function to calculate the distance:
