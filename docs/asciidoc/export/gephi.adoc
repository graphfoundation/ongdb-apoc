...
You can provide your workspace name (you might want to rename it before you start this streaming), otherwise it defaults to `workspace0`
...
We send all nodes and relationships of the passed in data convert into individual Gephi-Streaming JSON fragments, separated by `\r\n`.
