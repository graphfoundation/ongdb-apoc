...
Refers to the issue https://github.com/graphfoundation/ongdb-apoc/issues/439/[#439] we documented some performance tests of export and import of a big graph into Cypher format file.
...
It was created an issue about this https://github.com/graphfoundation/ongdb-apoc/issues/500[#500].
