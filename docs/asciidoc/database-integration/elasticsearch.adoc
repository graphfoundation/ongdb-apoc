...
[abstract]
--
This section describes procedures that can be used to interact with Elastic Search.
--
...
|===
include::../../../build/generated-documentation/apoc.es.csv[]
|===
...
CALL apoc.es.get("localhost","_search","scroll",null,{scroll:"5m",scroll_id:scrollId},null) yield value with value._scroll_id as scrollId, value.hits.hits as nextHits
